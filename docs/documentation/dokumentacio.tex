...
\subsection{\texttt{point\_generator.py}: A ponthalmaz generátor}
...
\subsection{\texttt{genetic\_algorithm.py}: A körillesztő algoritmus}
...
\subsection{\texttt{main.py}: A központi vezérlő szkript}
...
\subsection{\texttt{evaluation.py}: A kiértékelő modul}
...
A genetikus algoritmusok teljesítményét nagyban befolyásolják a beállított hiperparaméterek. Kiemelten vizsgáltuk a \textbf{mutációs ráta} hatását, mivel ez felelős a populáció sokszínűségének fenntartásáért és a lokális optimumok elkerüléséért.
